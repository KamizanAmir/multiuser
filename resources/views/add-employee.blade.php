...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Employee add') }}</div>
                ...
                <form action="{{ route('add-employee.store') }}" method="POST" class="p-4">
                    ...
                    <button type="submit" class="btn btn-primary align-self-start">Add Employee</button> <!-- Aligned button to the start (left) -->
                </form>
                @if (session('status'))
                <script>
